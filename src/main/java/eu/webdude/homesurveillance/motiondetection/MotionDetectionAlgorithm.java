package eu.webdude.homesurveillance.motiondetection;

import eu.webdude.homesurveillance.motiondetection.filters.JHBlurFilter;
import eu.webdude.homesurveillance.motiondetection.filters.JHGrayFilter;
 ...
 */
public class MotionDetectionAlgorithm implements MotionDetectionStrategy {
     ...
     */
    public MotionDetectionAlgorithm(int pixelThreshold, double areaThreshold) {
